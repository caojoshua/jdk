...
Node* GraphKit::cast_not_null(Node* obj, bool do_replace_in_map) {
  ...
  Node* orig_cast = new CastPPNode(obj,t_not_null);
  // TODO: Need to cast old cast as well?
  orig_cast->init_req(0, control());
...
Node* GraphKit::cast_common(Node* n, const TypeOopPtr* t, PhaseGVN *gvn) {
  ...
  if (gvn) {
    // TODO: do we need to alias to old cast as well?
